...
class SettingsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.settings.index', compact('settings','roleuser'));
    }
    ...
    public function create()
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.settings.create','roleuser');
    }
    ...
    public function edit(Setting $setting)
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.settings.edit', compact('setting','roleuser'));
    }
    ...
    public function show(Setting $setting)
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.settings.show', compact('setting','roleuser'));
    }
