...
class SponsorsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.sponsors.index', compact('sponsors','roleuser'));
    }
    ...
    public function create()
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.sponsors.create',compact('roleuser'));
    }
    ...
    public function edit(Sponsor $sponsor)
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.sponsors.edit', compact('sponsor','roleuser'));
    }
    ...
    public function show(Sponsor $sponsor)
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.sponsors.show', compact('sponsor','roleuser'));
    }
