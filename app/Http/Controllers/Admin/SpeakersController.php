...
class SpeakersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.speakers.index', compact('speakers','roleuser'));
    }
    ...
    public function create()
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.speakers.create',compact('roleuser'));
    }
    ...
    public function edit(Speaker $speaker)
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.speakers.edit', compact('speaker','roleuser'));
    }
    ...
    public function show(Speaker $speaker)
    {
        ...
        $user = \Auth::user();
        $roleuser=$user->roles->first()->title;
        return view('admin.speakers.show', compact('speaker','roleuser'));
    }
