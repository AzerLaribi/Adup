...
class FaqsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.faqs.index', compact('faqs','roleuser'));
    }
    ...
    {  $user = \Auth::user();
        ...
        return view('admin.faqs.create',compact('roleuser'));
    }
    ...
    public function edit(Faq $faq)
    {
        ...
        return view('admin.faqs.edit', compact('faq','roleuser'));
    }
    ...
    public function show(Faq $faq)
    {
        ...
        return view('admin.faqs.show', compact('faq','roleuser'));
    }
