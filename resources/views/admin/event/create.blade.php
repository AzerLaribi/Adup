    ...
    <div class="card-body">
        <form action="{{ route("admin.events.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                ...
                <input type="date" id="start_time" name="start_time" class="form-control" value="{{ old('model', isset($event) ? $event->start_time : '') }}" required>
               
                
            </div>
            <div class="form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                <label for="start">finish_time*</label>
                <input type="date" id="finish_time" name="finish_time" class="form-control" value="{{ old('model', isset($event) ? $event->finish_time : '') }}" required>
