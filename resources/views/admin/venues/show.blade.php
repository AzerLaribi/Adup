...
$countAds  = DB::table('ad_venue')->join('ads', 'ads.id', '=', 'ad_venue.ad_id')
...
<div class='card'>
    ...
    <div class="col-lg-3 col-6">
        <img src="{{ asset('/image/LocationPartner/'.$venue->logo)}}" width="100" height="100">
    </div>
    <div class="card-body">
    <div class="content">
    <div class="row">
       @if($roleuser =='Admin' || $roleuser =='locationOwner' )
        <div class="col-lg-3 col-6">
                <!-- small box -->
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{$countRasbaryLocations}}</h3>
    ...
    <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{$countAds}}</h3>
                   <a  href="/admin/{{$venue->id}}/adsInmylocations"> <p>Ads</p> </a>
...
<script>
  ...
  //today +3
      ...
      datasets: [
        {
          ...
          data                : [ <?php echo $lastlastYesterdayMale?>, <?php echo $lastyesterdaydayMale?>, <?php echo $yesterdayMale?>, <?php echo $todayMale?>,
          <?php echo $tomorowMale?>, <?php echo $aftertomorowMale?>,  <?php echo $afteraftertomorowMale?>]
        },
        {
          label               : 'females',
          ...
          data                : [ <?php echo $lastlastYesterdayFeMale?>, <?php echo $lastyesterdayFeMale?>, <?php echo $yesterdayFeMale?>, <?php echo $todayFeMale?>,
           <?php echo $tomorowFeMale?>, <?php echo $aftertomorowFeMale?>,  <?php echo $afteraftertomorowFeMale?>]
        },
      ]
    }
    ...
    var donutData        = {
      ...
      datasets: [
        {
          data: [<?php echo $young?>,<?php echo $youngAdults?>,<?php echo $adults?>
    ...
    var piee        = {
      ...
      datasets: [
        {
          data: [<?php echo $allInfoMale->count()?>,<?php echo $allInfoFeMale->count()?>,],
          backgroundColor : ['#f56954', '#00a65a', '#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de'],
        }
      ]
    }
