        ...
        <div class="row justify-content-center">
            <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                    <h2 id="heading">Sign Up Your Location Partener Account</h2>
                    <form id="msform" class="form" method="POST" action="{{ route('locationpartner.store') }}" enctype="multipart/form-data">
                        @csrf
                        <!-- progressbar -->
                        <ul id="progressbar">
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col-md-6 ">
                                        <label class="fieldlabels">Secteur: *</label>
                                        ...
                                        @enderror
                                        If you don't find your Secteur
                                        <div style="margin-bottom: 10px;" class="row">
                                            <div class="col-lg-12">
                                                <a class="btn btn-success" href="/AddType">
                                                 Add Secteur <i class="bi bi-plus-circle"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <label class="fieldlabels">Business Tags: *</label>
                                        <select name="location_tags" id="location_tags" class="form-control">
                                        @foreach($tags as $tag)
                                        ...
                                        @enderror
                                        If you don't find your Tag
                                        <div style="margin-bottom: 10px;" class="row">
                                            <div class="col-lg-12">
                                                <a class="btn btn-success" href="/AddTag">
                                                 Add tags <i class="bi bi-plus-circle"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="input-group">
                                    <label class="fieldlabels">Email pro: </label>
